...
Since Python 3.8, "AsyncMock" and "MagicMock" have support to mock 异
步迭代器 through "__aiter__". The "return_value" attribute of
"__aiter__" can be used to set the return values to be used for
iteration.
...
Since Python 3.8, "AsyncMock" and "MagicMock" have support to mock 异
步上下文管理器 through "__aenter__" and "__aexit__". By default,
"__aenter__" and "__aexit__" are "AsyncMock" instances that return an
async function.
