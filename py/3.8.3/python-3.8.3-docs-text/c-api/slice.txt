...
int PySlice_GetIndicesEx(PyObject *slice, Py_ssize_t length, Py_ssize_t *start, Py_ssize_t *stop, Py_ssize_t *step, Py_ssize_t *slicelength)
   ...
   *slicelength*.  Out of bounds indices are clipped in a manner
   ...
   在 3.6.1 版更改: If "Py_LIMITED_API" is not set or set to the value
   between "0x03050400" and "0x03060000" (not including) or
   ...
   3.6.1 版后已移除: If "Py_LIMITED_API" is set to the value less than
   "0x03050400" or between "0x03060000" and "0x03060100" (not
